...
public class AgentsList extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemClickListener, LocationListener, NetworkStateReceiver.NetworkStateReceiverListener {
     ...
     * @param batchesGetResponseList This  is the list of the Body class of the Agents Get Class.
     */
    ...
    /**
     *This function return the API Results according to its response code, it will be failure or success. & populates the list of Agents.
     */
...
//                    }
    ...
    /**
     * This functions click got the values of Agents for the Stock Allocation purpose from driver side with an alert dialog for confirmation.
     * @param v
     */
...
//        Toast.makeText(this, "Nothing is here....", Toast.LENGTH_SHORT).show();
    ...
    /**
     *  This function shows the Agent's profile on the click of the list with an image of the profile on it. That will be a dialog box.
     * @param parent
     * @param view
     * @param position
     * @param id
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        Integer fileid =0;
        if(bodyArrayList1.get(position).getAttachments().size()!=0) {
            fileid = bodyArrayList1.get(position).getAttachments().get(0).getId();
        ...
        {
            Toast.makeText(this, "Details not found for this user", Toast.LENGTH_SHORT).show();
        }
