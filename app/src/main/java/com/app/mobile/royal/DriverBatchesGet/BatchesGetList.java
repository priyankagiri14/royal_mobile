...
public class BatchesGetList extends AppCompatActivity implements View.OnClickListener ,SearchView.OnQueryTextListener, LocationListener, NetworkStateReceiver.NetworkStateReceiverListener {
...
//                populateListView(list1.get(0).getBody());
    ...
    public void onClick(View v) {
        ...
        if (count == 0) {
            Toast.makeText(BatchesGetList.this, "Please Select any Batch", Toast.LENGTH_SHORT).show();
        } else {
            Log.d("PNK", "ONCLICK");
            Log.d("PNK", "" + v.getId());
