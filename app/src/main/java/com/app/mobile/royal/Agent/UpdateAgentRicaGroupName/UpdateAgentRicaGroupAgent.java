package com.app.mobile.royal.Agent.UpdateAgentRicaGroupName;
...
public class UpdateAgentRicaGroupAgent extends AppCompatActivity {
    private static final String TAG = "UpdateAgentRicaGroupAgent" ;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R. layout.activity_update_agent_rica_group_agent);
        initViews();
        ...
        btn_submit_rica.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (username.isEmpty()) {
                    ...
                    Toast.makeText(UpdateAgentRicaGroupAgent.this, "Please accept the agreement", Toast.LENGTH_SHORT).show();
                } else {
        ...
        try {
            ...
            call.enqueue(new Callback<ResponseBody>() {
                ...
                public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                    if(response.isSuccessful() && response.code() == 200)
                    {
                        ...
                        try {
                            ...
                            Intent intent = new Intent(UpdateAgentRicaGroupAgent.this, Agent_Mainactivity.class);
                ...
                public void onFailure(Call<ResponseBody> call, Throwable t) {
                    ...
                    Toast.makeText(UpdateAgentRicaGroupAgent.this, t.getLocalizedMessage(), Toast.LENGTH_SHORT).show();
