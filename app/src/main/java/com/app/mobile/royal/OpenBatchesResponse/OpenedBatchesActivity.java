...
public class OpenedBatchesActivity extends AppCompatActivity implements View.OnClickListener, LocationListener, NetworkStateReceiver.NetworkStateReceiverListener {
     ...
     * @param batchesReceivedResponseList This  is the list of the Body class of the OpenedBatches Class.
     */
...
//                populateListView(strings);
    ...
    /**
     * This functions click stops the batch numbers from user side with an alert dialog for confirmation.
     * @param v
     */
