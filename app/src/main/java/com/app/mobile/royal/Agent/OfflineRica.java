...
public class OfflineRica extends AppCompatActivity implements View.OnClickListener, RadioGroup.OnCheckedChangeListener, NetworkStateReceiver.NetworkStateReceiverListener, com.google.android.gms.location.LocationListener, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
    ...
    private void showAlert() {
        if(!((Activity) OfflineRica.this).isFinishing())
        {
            //show dialog
            AlertDialog.Builder builder = new AlertDialog.Builder(this);
