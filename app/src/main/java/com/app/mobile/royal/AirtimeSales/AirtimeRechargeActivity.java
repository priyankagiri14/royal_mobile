...
public class AirtimeRechargeActivity extends AppCompatActivity implements View.OnClickListener, Callback<ResponseBody> , NetworkStateReceiver.NetworkStateReceiverListener {
