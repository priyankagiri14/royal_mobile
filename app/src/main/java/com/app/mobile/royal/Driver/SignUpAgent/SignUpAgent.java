...
public class SignUpAgent extends AppCompatActivity implements NetworkStateReceiver.NetworkStateReceiverListener {
    View rowView;
    ...
    public TextInputLayout idnumtext, passporttext, expirydatetext, signedattext;
    ...
    private LinearLayout basicdetailslinear, addresslinear, contactinfolinear,
            ...
            doctypespinnerlinear, distributorlinear, agentlinear, dailyratelinear;
    ...
    ImageView symbol;
    SharedPreferences warehousesSharedPreferences;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        warehouseId=warehousesSharedPreferences.getInt("warehouseid",0);
        Log.d("Warehouseidd is", String.valueOf(warehouseId));
       ...
       /* simcost4 = findViewById(R.id.simcost4);
        ...
        symbol.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                android.app.AlertDialog alertDialog = new android.app.AlertDialog.Builder(SignUpAgent.this).create();
                ...
                public void onResponse(Call<FetchOneAgent> call, Response<FetchOneAgent> response) {
                    if (response.isSuccessful() && response.code() == 200) {
                        ...
                        if (response.body() != null) {
                            ...
                            String ricastring = fetchOneAgentList.getProfile().getRicaUser();
                            String ricapswrdstring = fetchOneAgentList.getProfile().getRicaPassword();
                            String ricagroupstring = fetchOneAgentList.getProfile().getRicaGroup();
                            ...
                            if (fetchOneAgentList.getAttachments().size() != 0) {
                                ...
                                ArrayAdapter<CharSequence> doctypeadapter = ArrayAdapter.createFromResource(SignUpAgent.this, R.array.doctype_spinner, android.R.layout.simple_spinner_item);
                            ...
                            for (int i = 0; i < (fetchOneAgentList.getAttachments().size()) - 4; i++) {
                                ...
                                doctypeadapter = ArrayAdapter.createFromResource(SignUpAgent.this, R.array.doctype_spinner, android.R.layout.simple_spinner_item);
                                doctypeadapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
                                doctypespinner.setAdapter(doctypeadapter);
                                if (doctypestringfill != null) {
                                    int spinnerPosition = doctypeadapter.getPosition(doctypestringfill);
...
/*    String doctypestring = fetchOneAgentList.getAttachments().get(i).getType();
                            ...
                            */
                            ArrayAdapter<CharSequence> titleadapter = ArrayAdapter.createFromResource(SignUpAgent.this, R.array.title_spinner, android.R.layout.simple_spinner_item);
                         ...
                         /*   ArrayAdapter adapter = new ArrayAdapter(SignUpAgent.this,android.R.layout.simple_spinner_dropdown_item,
                            ...
                            ArrayAdapter<CharSequence> idadapter = ArrayAdapter.createFromResource(SignUpAgent.this, R.array.id_spinner, android.R.layout.simple_spinner_item);
                            ...
                            ArrayAdapter<CharSequence> provinceadapter = ArrayAdapter.createFromResource(SignUpAgent.this, R.array.province_spinner, android.R.layout.simple_spinner_item);
        ...
        signedattext = findViewById(R.id.tvsignedat);
        signedattext.setVisibility(View.GONE);
                ...
                if (nextbtncount == 0) {
                    ...
                    {*/
                        ...
                        if (titlespinner.getSelectedItem().toString().equals("Title")) {
                            ...
                            Toast.makeText(SignUpAgent.this, "Select Passport Expiry Date from Calender", Toast.LENGTH_SHORT).show();
                        } else {
                            nextbtncount++;
                            previousbtn.setVisibility(View.VISIBLE);
                            addresslinear.setVisibility(View.VISIBLE);
                    ...
                    if (streetno.getText().toString().length() == 0) {
                        ...
                        Toast.makeText(SignUpAgent.this, "Select Province!", Toast.LENGTH_SHORT).show();
    ...
    /*                    commision1linear.setVisibility(View.VISIBLE);
                    ...
                    if (simcost.getText().length() == 0
                     ...
                     /*   if (dailyrate.getText().length() == 0) {
                        ...
                        signedattext.setVisibility(View.VISIBLE);
        ...
        responseAuthorityCall.enqueue(new Callback<ResponseAuthority>() {
            ...
            public void onResponse(Call<ResponseAuthority> call, Response<ResponseAuthority> response) {
                if (response.isSuccessful() && response.code() == 200) {
                    ...
                    authorityadapter = new ArrayAdapter(SignUpAgent.this, android.R.layout.simple_spinner_dropdown_item,
                            strings);
        ...
        warehouseResponseCall.enqueue(new Callback<WarehouseResponse>() {
            ...
            public void onResponse(Call<WarehouseResponse> call, Response<WarehouseResponse> response) {
                if (response.isSuccessful() && response.code() == 200) {
                    ...
                    warehouseadapter = new ArrayAdapter(SignUpAgent.this, android.R.layout.simple_spinner_dropdown_item,
                            warehousearray);
...
/*            commision1linear.setVisibility(View.GONE);
     ...
     * @param password       This is the password for the user name of the user who is signing up as an agent.
...
/*        JSONObject attachmentObject = new JSONObject();
   ...
   /*     if(status.equals("Enabled"))
        ...
        try {
            ...
            Log.d(TAG, "authorityObject: "+authorityObject.toString());
