...
import com.app.mobile.royal.OpenBatchesResponse.Body;
...
public class OpenCloseActivity extends AppCompatActivity implements LocationListener, NetworkStateReceiver.NetworkStateReceiverListener {
     ...
     * @param batchesReceivedResponseList This  is the list of the Body class of the OpenCloseBatches Class.
     */
...
//        onLocationChanged(location);
        ...
        btnstatus1.setOnClickListener(new View.OnClickListener() {
            /**
             * This function shows the alert box to the user for getting the confirmation from the user for starting the batch.
             * @param v
             */
            @Override
...
//                });
    ...
    /**
     * This function returns the API results success as serials of the batch number passed with batch id.
     */
