...
public class Sim_allocation extends AppCompatActivity implements View.OnClickListener, RadioGroup.OnCheckedChangeListener, NetworkStateReceiver.NetworkStateReceiverListener,com.google.android.gms.location.LocationListener, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
    ...
    private static final String TAG = "SimAllocation";
    private AlertDialog alertDialog;
    private boolean sim_alloc_passport = false; //passport
    private boolean sim_alloc_id = false; //id
    ...
    public void onCreate(Bundle savedInstancestate) {
        ...
        db = Room.databaseBuilder(MyApp.getContext(), AppDatabaseSerials.class, "serials")
                ...
                .build();
        // Log.d(TAG, "onCreate: serials from db:"+db.serialsInterface().serialstabledata());
        ...
        address.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Log.d(TAG, "onClick: call places function");
    ...
    private void showNationalitySpinner() {
        ...
        ArrayAdapter<CountryModel> nationality_spinner_adapter = new ArrayAdapter<>(Sim_allocation.this,
    ...
    private void hitSearchSerialsApi() {
        ...
        call.enqueue(new Callback<ResponseBody>() {
                ...
                if(response.isSuccessful() && response.code() == 200)
                {
                    ...
                    try{
                        ...
                        if(bodyArray.length()>0) {
                            ...
                            Toast.makeText(Sim_allocation.this, "No serial found, please try again with different serial", Toast.LENGTH_SHORT).show();
                        }
                    ...
                    Toast.makeText(Sim_allocation.this, "Some error occurred, please try again", Toast.LENGTH_SHORT).show();
                }
            ...
            public void onFailure(Call<ResponseBody> call, Throwable t) {
                ...
                Toast.makeText(Sim_allocation.this, t.getLocalizedMessage(), Toast.LENGTH_SHORT).show();
                ...
                if (response.isSuccessful() && response.code() == 200) {
                    ...
                    if (response.body() != null) {
                        ...
                        if(!isRica)
                        {
                            ...
                            Pref.setIsRica(Sim_allocation.this,isRica+"");
                        }
                    }
                }

                else {
                    Toasty.warning(Sim_allocation.this,"Some Error Occurred").show();
        ...
        btn_submit_rica.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (username.isEmpty()) {
                    ...
                    Toast.makeText(Sim_allocation.this, "Please accept the agreement", Toast.LENGTH_SHORT).show();
                } else {
       ...
       /* if (fname.getText().toString().length() == 0 || lname.getText().length() == 0 || address.length() == 0 ||
            ...
            if(idspinner.getSelectedItem().toString().equals("ID")) {
                if (fname.getText().toString().length() == 0 || lname.getText().length() == 0 || address.length() == 0 ||
                        ...
                        || regionspinner.getSelectedItemPosition() == 0 || searchView.getText().length() == 0 || idnum.getText().length() == 0 || idspinner.getSelectedItem().toString() .equals( "ID Type")) {
                    Toast.makeText(this, "Enter required fields", Toast.LENGTH_SHORT).show();
                } else {
                ...
                if (fname.getText().toString().length() == 0 || lname.getText().length() == 0 || address.length() == 0 ||
                        pincode.getText().toString().length() == 0 || subhurb.getText().toString().length() == 0 || TextUtils.isEmpty(network)
                        || regionspinner.getSelectedItemPosition() == 0 || searchView.getText().length() == 0 || passport.getText().length() == 0 || expirydate.getText().length() == 0 || idspinner.getSelectedItem().toString() .equals( "ID Type")) {
                    Toast.makeText(this, "Enter required fields", Toast.LENGTH_SHORT).show();
                } else {
                ...
                public void onResponse(Call<Simallocatemodel> call, Response<Simallocatemodel> response) {
                    if(response.isSuccessful() && response.code()==200) {
                        ...
                        if (success.equals("true")) {
                            ...
                            if(isDriver!=null)
                            {
                                Intent intent = new Intent(Sim_allocation.this, Stocks_dashboard.class);
