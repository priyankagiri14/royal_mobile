package com.app.mobile.royal.DriverBatchesGet;
...
public class NormalBatchesGetList extends AppCompatActivity implements View.OnClickListener ,SearchView.OnQueryTextListener, LocationListener , NetworkStateReceiver.NetworkStateReceiverListener {
     ...
     * @param batchesGetResponseList This  is the list of the Body class of the Agent Batches Get Class.
     */
    ...
    /**
     * This function is setting up the search view with some properties.
     */
    ...
    /**
     *This function return the API Results according to its response code, it will be failure or success.
     */
...
//                populateListView(list1.get(0).getBody());
            ...
            public void onFailure(Call<BatchesGetResponse> call, Throwable t) {
                Toast.makeText(NormalBatchesGetList.this, t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    /**
     * This functions click got the values of batch numbers for receiving it from user side with an alert dialog for confirmation.
     * @param v
     */
    ...
    public void onClick(View v) {
        ...
        if (count == 0) {
            Toast.makeText(NormalBatchesGetList.this, "Please Select any Batch for Receiving", Toast.LENGTH_SHORT).show();
        } else {
            Log.d("PNK", "ONCLICK");
            Log.d("PNK", "" + v.getId());

            AlertDialog alertDialog = new AlertDialog.Builder(NormalBatchesGetList.this).create();
                ...
                public void onClick(DialogInterface dialogInterface, int which) {
                    ...
                    call.enqueue(new Callback<AllocationStatusResponse>() {
                        ...
                        public void onResponse(Call<AllocationStatusResponse> call, Response<AllocationStatusResponse> response) {
                            ...
                            Toast.makeText(NormalBatchesGetList.this, message, Toast.LENGTH_SHORT).show();
                        }
                    ...
                    Intent intent = new Intent(NormalBatchesGetList.this, Stocks_dashboard.class);
            ...
            alertDialog.setButton(Dialog.BUTTON_NEGATIVE, "DECLINE", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    if (count == 0) {
                        Toast.makeText(NormalBatchesGetList.this, "Please Select any Batch for Decline", Toast.LENGTH_SHORT).show();
                    } else {
                        Web_Interface web_interface = RetrofitToken.getClient().create(Web_Interface.class);
...
//
    ...
    public void onProviderDisabled(String provider) {
        ...
        if(!((Activity) NormalBatchesGetList.this).isFinishing())
        {
            //show dialog
            ...
            alertDialog.setButton(DialogInterface.BUTTON_NEGATIVE, "Cancel", new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialog, int which) {
                    startActivity(new Intent(NormalBatchesGetList.this, Stocks_dashboard.class).addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP));
                }
            });
            alertDialog.show();
